...
Each layer represents a classification of Law. This helps eliminate conflicts and reduce logical overhead with _specificity_, which we will talk about later. Here's what each layer is for:
