...
- **Natural Language:** Built from the ground up to support modern NLP. The engine understands _Intent_ ("Bowl the ball") rather than just strict syntax (`USE BALL ON LANE`).
